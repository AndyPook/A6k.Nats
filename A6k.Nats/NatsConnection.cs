...
namespace A6k.Nats
{
    public class f : IConnectionFactory
    {
        ...
        public IConnectionFactory CreateConnectionFactory(IServiceProvider serviceProvider)
        {
            var f = new ConnectionBuilder(serviceProvider)
                .us
        }
    }
